...
if (!process.env.STRIPE_SECRET_KEY) {
  console.error(
    "❌ STRIPE_SECRET_KEY is required. Please set it in your .env file or as an environment variable.",
  )
...
if (!process.env.PROJECT_URL) {
  console.error("❌ PROJECT_URL is required. Please set it in your .env file.")
  process.exit(1)
}
...
const membershipPlans = [
  {
    ...
    description: 'One-time access to any group class',
    price: 1000,
    features: [
      'Access to any group class',
  ...
  },
  {
    ...
    description: "Personalised one-on-one Muay Thai training session with experienced instructor",
    price: 3000, // £45.00 in pence
    features: [
      "One-on-one personal training",
      "Customised technique instruction",
      "Flexible scheduling",
      "Equipment provided",
      "60-minute session",
    ],
  ...
  {
    name: "Private Group Class (2 People)",
    description: "Private Muay Thai training session for 2 people",
    price: 4000, // £75.00 in pence
    features: [
      "Private group training for 2",
      "Shared cost between participants",
      "Partner drills and techniques",
      "Flexible scheduling",
      "Equipment provided",
      "60-minute session",
    ],
  ...
  {
    name: "Private Group Class (3 People)",
    description: "Comprehensive training with unlimited personal sessions",
    price: 5000, // £120.00 in pence
    features: [
      "Private group training for 3",
      "Cost-effective group option",
  ...
  for (const plan of membershipPlans) {
    try {
      ...
      if (error) {
        ...
        console.log(
          `   ✅ Updated in Supabase: ${existingPlan ? "Updated existing" : "Created new"} plan`,
        )
      }
    } catch (error) {
