...
export function useModal() {
  ...
  const confirmDelete = (message: string = 'Are you sure you want to delete this item?'): Promise<boolean> => {
    return openModal({
  ...
  const confirmCancel = (message: string = 'Are you sure you want to cancel?'): Promise<boolean> => {
    return openModal({
